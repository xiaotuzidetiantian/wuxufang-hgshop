...
<link rel="icon" type="image/png" sizes="144x144"
	href="/resource/img/loading.gif" />
<link href="/resource/bootstrap4/css/bootstrap.css" rel="stylesheet">
<script type="text/javascript" src="/resource/jquery/jquery-3.4.1.js">
...
<body>
	<nav
		...
		<a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#"> 公司 </a> <input
			class="form-control form-control-dark w-100" type="text"
			placeholder="Search" aria-label="Search">
		<ul class="navbar-nav px-3">
			<li class="nav-item text-nowrap"><a class="nav-link" href="#">注销</a>
			</li>
		</ul>
	</nav>
	...
	<div class="container-fluid">
		<div class="row">
				...
				<div class="sidebar-sticky">
					<ul class="nav flex-column">
						...
						<li class="nav-item"><a class="nav-link" href="#"
							data-target="/cat/tree"> <svg
									...
									<path
										d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path>
									<polyline points="13 2 13 9 20 9"></polyline></svg> 分类管理
						</a></li>
						<li class="nav-item"><a class="nav-link" href="#"
							data-target="/spu/list"> <svg
									xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
						...
						<li class="nav-item"><a class="nav-link" href="#"
							data-target="/sku/list"> <svg
									...
									<path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg> sku管理
						</a></li>
					</ul>
					...
					<ul class="nav flex-column mb-2">
						<li class="nav-item"><a class="nav-link" href="#"> <svg
									...
									<polyline points="10 9 9 9 8 9"></polyline></svg> 月报
						</a></li>
						<li class="nav-item"><a class="nav-link" href="#"> <svg
									xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									...
									<line x1="16" y1="13" x2="8" y2="13"></line>
									<line x1="16" y1="17" x2="8" y2="17"></line>
									<polyline points="10 9 9 9 8 9"></polyline></svg> 季度报表
						</a></li>
			...
			<h2></h2>
			<div class="table-responsive" id="workcontent">工作区内容</div>
			</main>
		</div>
	</div>
