...
<div class="container">
	<div class="container">
		<form action="" id="skuForm">
			<input type="hidden" name="spuId" value="${sku.spu.id}"> <input
				type="hidden" name="id" value="${sku.id}">
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">商品名称</label>
				<div class="col-sm-10">
					<input type="text" disabled="disabled" value="${sku.spu.goodsName}"
						class="form-control">
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" name="title" value="${sku.title}"
						class="form-control">
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" name="sellPoint" value="${sku.sellPoint}"
						class="form-control">
				</div>
			</div>
			<div class="form-group row">
							...
							<select name="specId" onchange="specChange(this)">
								<c:forEach items="${specList}" var="spec">
									<option value="${spec.id}"
										<c:if test="${spec.id==op.specId}">selected="selected" </c:if>>${spec.specName}</option>
								</c:forEach>
							</select>
						</div>
						<div class="col-md-2">
